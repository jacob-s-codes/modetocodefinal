                ...
                <div className=" w-full max-w-[1800px] mx-auto px-8 flex flex-col gap-y-44 justify-between  pt-32 ">
                    ...
                    <div className="flex lg:flex-row flex-col parent-leftright lg:items-center items-end justify-between ">
                        ...
                        <div className="text-3xl max-w-2xl text-right pl-8 animateleft">
                            ...
                            <p className="py-12 text-2xl font-light">Mode to Code is proud to be offering programs at schools all over San Francisco. We are also teaching students online in Vermont, India, Bolivia, and Italy. We are proud to have over 100 hours of instruction to students accross the globe!</p>
