                    ...
                    <div className="w-full px-4 lg:py-44 py-36 z-20">
                        ...
                        <div className="pt-12 relative ">
                            ...
                            <div className="grid lg:grid-cols-4 grid-cols-1 gap-8 lg:gap-y-0 gap-y-12 items-center justify-items-center">
                                ...
                                <a href="https://youtu.be/qNz7SYaRR2Y?si=QpYwMbmrz5xRi-Tv" target="_blank" className="hover:rotate-4 hover:scale-105 duration-300"><img src="/news/logo/kronlogo.svg" alt="SF Chronicle" className="w-72 h-auto" /></a>
                            </div>
