                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-start pb-8 gap-8">
                            <div className="flex flex-col items-start gap-y-2">
                                <div className="flex flex-row items-center gap-x-3">
                                    ...
                                    <h3 className="text-3xl text-blue-900 font-bold">1500+ Students</h3>
                                </div>
                                <p className="lg:pl-3 text-xl font-light">Over fifteen hundred students taught</p>
                            </div>
                            <div className="flex flex-col items-start gap-y-2">
                                <div className="flex flex-row items-center gap-x-3">
                                    <svg className="h-8" viewBox="0 0 44 665" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full px-4 lg:py-44 py-36 z-20">
                        ...
                        <div className="pt-12 relative ">
                            ...
                            <div className="grid lg:grid-cols-4 grid-cols-1 gap-8 lg:gap-y-0 gap-y-12 items-center justify-items-center">
                                ...
                                <a href="https://www.ktvu.com/news/teen-teaching-ai-free-grows-program-international-movement" target="_blank" className="hover:rotate-4 hover:scale-105 duration-300"><img src="/news/logo/foxlogo.png" alt="Fox News" className="lg:w-64 w-60 h-auto" /></a>
                            </div>
