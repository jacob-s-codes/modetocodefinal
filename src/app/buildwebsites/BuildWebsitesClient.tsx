    ...
    return (
        <div className='w-full overflow-x-hidden overflow-y-hidden bg-gradient-to-b from-white to-blue-300'>
            ...
            <div className='w-full'>
                ...
                <CardRight title={"Step 4: Tailwind CSS"} description={'Once you\'ve got the basics of HTML and CSS, you can start customizing and styling your websites to look cool and modern. I used Tailwind CSS to make this website, so I highly recommend it! Here\'s a free 4 hour course that will teach you everything you need!'} imageUrl={'/tailwindlogo.webp'} buttonText={'Try it out!'} buttonUrl={'https://www.youtube.com/watch?v=ft30zcMlFao'} ></CardRight>
