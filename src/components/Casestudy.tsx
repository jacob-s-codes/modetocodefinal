...
export default function Casestudy({ place, title, image, description, link }: { place: string, title: string, image: string, description: string, link: string }) {
  return (
    <div className='flex flex-col gap-x-4 lg:gap-y-6 gap-y-12 hover:shadow-2xl px-4 pt-4 pb-8 lg:h-[450px] hover:shadow-black duration-300 lg:w-80 w-full h-auto rounded-lg lg:bg-blue-200 bg-blue-300 border-2 border-black '>
