...
export default function TeachingMap() {
    return (
        <MapContainer center={[51.505, 2]} zoom={2} scrollWheelZoom={false} dragging={false} zoomControl={false} doubleClickZoom={false} keyboard={false} className="w-full rounded-xl z-0" style={{ height: "calc(100vh - 200px)" }}>
            <TileLayer
